...
var CLINIC_NOTICES = [
    { end: '2026-09-28', date: '9/28(月)',             text: '午後休診' },
    { end: '2026-10-19', date: '10/19(月)',            text: '午後受付終了4:30（コンタクトレンズ検査受付なし）' },
    { end: '2026-10-30', date: '10/29(木)〜10/30(金)', text: '休診' },
    { end: '2026-11-17', date: '11/17(火)',            text: '受付時間11:30まで（コンタクトレンズ検査受付なし）' },
    { end: '2026-11-19', date: '11/19(木)',            text: '午後受付終了4:30（コンタクトレンズ検査受付なし）' }
];
